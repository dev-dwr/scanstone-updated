...
const ContactComp = () => {
    ...
    return(
    <section className="bg-white py-20  overflow-hidden relative z-10">
            ...
            <div className="max-w-[570px] mb-12 lg:mb-0">
               ...
               <div className="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div className="w-full">
                     <h4 className="font-bold text-dark text-xl mb-1">Nasza lokalizacja</h4>
               ...
               <div className="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div className="w-full">
                     <h4 className="font-bold text-dark text-xl mb-1">Number telefonu</h4>
                     <p className="text-base text-body-color">inż. Sebastian Rymarczyk: <br/>(+48) 603 110 680</p><br/>
                     <p className="text-base text-body-color">inż. Roman Róg: <br/>(+48) 601 567 990</p>
                  </div>
               </div>
               <div className="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div className="w-full">
                     ...
                     <p className="text-base text-body-color">biuro@scanstone.pl</p>
                  </div>
               </div>
            </div>
         </div>
