  ...
  return (
    <footer class="p-4 text-white bg-gradient-to-r from-sky-500 to-indigo-500 rounded-lg shadow md:px-6 md:py-8">
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <ul class="flex flex-wrap items-center text-white mb-6 text-sm  sm:mb-0">
          <li>
...
//   <div className="grid grid-cols-2 sm:!grid-cols-2 gap-y-6 gap-x-6 md:!grid-cols-3 md:gap-64 xs:grid-cols-1">
//     <div className="mb-4 flex flex-col xs:col-span-2">
//       <span className="text-xl font-bold capitalize mb-6">ScanStone</span>
...
//                <p className="text-base  !text-sm text-body-color">
//                58-152 Rogoźnica
//               ul. Świdnicka 17
//               działka przy drodze 374
//                </p>
//             </div>
//          </div>
...
//             </div>
//             <div className="w-full">
//                <p className="text-base text-body-color mt-0 !text-sm">603 110 680</p><br/>
//                <p className="text-base text-body-color !text-sm">601 567 990</p>
//             </div>
//          </div>
//       <br/>
//       {/* biuro@scanstone.pl */}
...
//             </div>
//             <div className="w-full">
//                <p className="mt-6 !text-sm">biuro@scanstone.pl</p>
//             </div>
//          </div>
//       </p>
//       <ul
